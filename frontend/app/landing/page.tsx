...
export default function LandingPage() {
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      {/* Hero Section */}
      <section className="relative overflow-hidden hero-gradient min-h-[calc(100vh-4rem)] sm:min-h-[calc(100vh-5rem)] lg:min-h-[calc(100vh-6rem)] flex items-center">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-10 lg:py-12 ">
          <div className="lg:grid lg:grid-cols-12 lg:gap-8 items-center">
            <div className="lg:col-span-6 animate-fade-in-up text-center lg:text-left">
              ...
              <h1 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-bold text-neutral-900 mb-4 leading-tight">
                <span className="text-primary-600 block bg-gradient-to-r from-primary-600 to-primary-700 bg-clip-text text-transparent">
                  {t("hero.title")}
                </span>
              </h1>

              <p className="text-base sm:text-lg text-neutral-600 mb-6 max-w-2xl leading-normal mx-auto lg:mx-0">
                {t("hero.subtitle")}
              </p>
            ...
            <div
              className="lg:col-span-6 mt-8 sm:mt-12 lg:mt-0 animate-fade-in-up px-4 sm:px-0"
      ...
      <section id="features" className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center mb-20">
            ...
            <div
              className="animate-fade-in-up lg:pl-8 mt-8 lg:mt-0"
              style={{ animationDelay: "0.2s" }}
            >
              <div className="bg-gradient-to-br from-blue-50 to-primary-50 rounded-2xl p-6 sm:p-8 shadow-lg">
                <div className="bg-white rounded-lg p-4 sm:p-6 mb-4 shadow-sm">
                  ...
                  <p className="text-xs text-neutral-600 text-center">
                    Instant tree generation • Sub-second
                  </p>
                </div>
                <div className="text-center">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-center mb-12 sm:mb-16 lg:mb-20">
            ...
            <div
              className="animate-fade-in-up lg:order-1"
              style={{ animationDelay: "0.2s" }}
            >
              <div className="bg-gradient-to-br from-green-50 to-accent-50 rounded-2xl p-8 shadow-lg">
                ...
                <div className="flex items-center gap-3">
                  ...
                  <span className="text-sm text-neutral-700">
                    Official family-book rules applied
                  </span>
                </div>
              </div>
            </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-center mb-12 sm:mb-16 lg:mb-20">
            ...
            <div
              className="animate-fade-in-up lg:pl-8"
              style={{ animationDelay: "0.2s" }}
            >
      ...
      <footer className="bg-neutral-900 text-white py-12">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            ...
            <p className="text-neutral-400 text-sm">{t("footer.authority")}</p>
          </div>
